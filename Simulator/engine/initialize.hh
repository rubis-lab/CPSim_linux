//create resources
Resource *r1 = new Resource(0, 1, 100, 100, "ecu1");
r1->schedululer_link = new Scheduler_Universal(2, 1);
resources.push_back(r1);
Resource *r2 = new Resource(1, 1, 100, 180, "ecu2");
r2->schedululer_link = new Scheduler_Universal(2, 1);
...
whole_task_functions(t1_function);
Task *t2_function = new Task2();
whole_task_functions(t2_function);
Task *t3_function = new Task3();
whole_task_functions(t3_function);
Task *t4_function = new Task4();
whole_task_functions(t4_function);
Task *t5_function = new Task5();
whole_task_functions(t5_function);
